...
def des_encrypt_dict(key, dic):
    plain = json.dumps(dic)
    return des_encrypt(key, plain)


def des_decrypt_dict(key, cipher):
    plain = des_decrypt(key, cipher)
    dic = json.loads(plain)
    return dic


if __name__ == "__main__":
    print(des_encrypt("12345678", '{"_uid": "4648f94d-9b4d-4c55-81e9-4a7a6f662af1"}'))
    print(des_encrypt_dict("12345678", {"_uid": "4648f94d-9b4d-4c55-81e9-4a7a6f662af1"}))